...
/*
 * XXX: strident_canon() is needed by the taskq code, but the rest is not. We
 * #ifdef most of this file for the purpose of providing strident_canon() to
 * the taskq code. This needs to split out into its own module.
 */
